...
class Grasp(genpy.Message):
  ...
  _full_text = """# Posture and position when gripping
warehouse/Pose grasp_pos

# Distance and direction when approaching
geometry_msgs/Vector3 grasp_approach

# Distance and direction during evacuation
geometry_msgs/Vector3 grasp_retreat

# lifting height
float64 up

# Gripper posture when gripping
int16 grasp_posture

# Front gripper posture
